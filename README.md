...
- UI is displayed on an SSD1309 display, it allows the user to view current sensor values, modify elays between reads, or disable each of the sensors and MQTT
